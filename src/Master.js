...
class MasterBody extends Component {
    ...
    render() {
        ...
        var accountInfo = getCookie("account_info");
        ...
        return <Layout style={{ minHeight: '100vh' }}>
            ...
            <Layout>
                <Header style={{ background: '#fff', padding: "0 32 0 0", textAlign: "right" }}>
                    {accountInfo ? <span>欢迎您！{accountInfo.name}，<Button type="link" onClick={this.onLogout}>退出登录</Button></span> : <Button type="link" onClick={() => this.props.props.history.push("/login", { redirect: { location: this.props.props.location } })}>登录</Button>}
                </Header>
