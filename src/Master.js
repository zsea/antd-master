...
const theme =modifyVars["@theme-name"] || "dark";
    ...
    render() {
        ...
        return <Layout style={{ minHeight: '100vh' }}>
            <Sider theme={theme} className="antd-master-menu-first-box" collapsible collapsed={this.state.collapsed} onCollapse={this.onCollapse}>
                <div className="ant-pro-sider-menu-logo" id="logo">
                    <a href="/">
                        ...
                        {this.state.system_visible ? <h1>{modifyVars["@system-name"]}</h1> : null}
                    </a>
                </div>
            ...
            <Layout>
                ...
                <Footer style={{ textAlign: 'center' }}>{modifyVars["@system-copyright"]}</Footer>
            </Layout>
        </Layout>;
    }
}
